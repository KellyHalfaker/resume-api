...
experience1 = Experience.new({start_date: Date.today - 10.days, end_date: Date.today - 2.days, job_title: "Very important dude", company_name: "Important People Inc.", details: "I was a very important dude"})
experience1.save
experience2 = Experience.new({start_date: Date.today - 15.days, end_date: Date.today - 1.days, job_title: "Cool gal", company_name: "Yoyoyoyoyo", details: "Very chill"})
experience2.save
experience3 = Experience.new({start_date: Date.today - 20.days, end_date: Date.today - 1.days, job_title: "Wow", company_name: "Great", details: "Excellent"})
experience3.save
...
education1 = Education.new({start_date: Date.today - 300.days, end_date: Date.today - 100.days, degree: "Bachelors in Partying", University_name: "Harvard", Details: "I was hecka good at partying"})
education1.save
education2 = Education.new({start_date: Date.today - 500.days, end_date: Date.today - 200.days, degree: "Bachelors in Napping", University_name: "Duke", Details: "
  Sleep is important"})
education2.save
education3 = Education.new({start_date: Date.today - 900.days, end_date: Date.today - 300.days, degree: "Bachelors in Napping", University_name: "MIT", Details: "I need 10 hours a night at least"})
education3.save
